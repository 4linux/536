Laboratório 536 - AWS Certified SysOps Administrator
=============================

Repositório para armazenar o Laboratório do curso 536 - AWS Certified SysOps Administrator da [4Linux][1]
...
---------- |:-----:|:-----------:|:-------------:|:---------------:
sysops-client     | 1     | 1024MB | 172.16.0.210 | ubuntu-20.04-amd64
...
```bash
git clone https://github.com/4linux/536
cd 536/
vagrant up
```
